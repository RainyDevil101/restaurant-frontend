...
const { get, post, postKeepingSession, patch, del } = vi.hoisted(() => ({
  ...
  postKeepingSession: vi.fn<typeof import('../client').api.postKeepingSession>(() =>
...
vi.mock('../client', () => ({
  api: { get, post, postKeepingSession, patch, put: vi.fn<typeof import('../client').api.put>(), delete: del },
}))
