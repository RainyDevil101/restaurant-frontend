...
vi.mock('@/shared/api/catalog', () => ({
  getCatalogStamp: vi
    .fn<typeof import('@/shared/api/catalog').getCatalogStamp>()
    .mockResolvedValue({
      products: { count: 0, lastModified: null },
      categories: { count: 0, lastModified: null },
      menus: { count: 0, lastModified: null },
    }),
...
import { useOrder } from '@/modules/service/composables/useOrder';
